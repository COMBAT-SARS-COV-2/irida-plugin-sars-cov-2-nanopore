 ...
 */
public class ArticNanoporePlugin extends Plugin {
	 ...
	 * for each pipeline).
	 */
	public static final AnalysisType DEFAULT = new AnalysisType("ARTIC_PIPELINE");

	public ArticNanoporePlugin(PluginWrapper wrapper) {
		super(wrapper);
	}
	...
	public static class PluginInfo implements IridaPlugin {
		...
		public UUID getDefaultWorkflowUUID() {
			return UUID.fromString("a772e5ee-efcc-4707-87c6-cd85cd406e57");
		}
